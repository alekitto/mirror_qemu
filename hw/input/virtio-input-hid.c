...
#define VIRTIO_ID_NAME_KEYBOARD     "NIMBUS Virtio Keyboard"
#define VIRTIO_ID_NAME_MOUSE        "NIMBUS Virtio Mouse"
#define VIRTIO_ID_NAME_TABLET       "NIMBUS Virtio Tablet"
#define VIRTIO_ID_NAME_MULTITOUCH   "NIMBUS Virtio MultiTouch"
